...
const GenderSummary = () => {
  ...
  <div className="flex justify-center gap-8">
    <div className="flex flex-col items-center">
      ...
      <span className="text-xl font-medium mt-2">{genderCounts.male} Male</span>
    </div>
    <div className="flex flex-col items-center">
      <FaFemale className="text-pink-600 text-[200px]" />
      <span className="text-xl font-medium mt-2">{genderCounts.female} Female</span>
    </div>
  </div>
  <div className="flex flex-col items-center">
    <FaUserAlt className="text-gray-600 text-[200px]" />
    <span className="text-xl font-medium mt-2">{genderCounts.others} Others</span>
  </div>
</div>
